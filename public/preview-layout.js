...
window.layoutContract = function(meta) {
  ...
  for(const n of source){
    ...
    if(n.tagName==='H2'){annex=true;body=sheet('Beilagen');place(n);for(const a of importedAnnexes){if(body.children.length>1)body=sheet('Beilagen');documentBlock(a);}continue;}
    documentBlock(n);
  }
